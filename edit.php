...
<body class="bg-primary bg-gradient">
  ...
  <main>
  <section class="box">
    // ADICIONAR SCRIPT PHP NO VALUE COM A VARIAVEL
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputEmail3" value="<?php echo $serie ?>" name="serie">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputEmail3" value="<?php echo $matricula ?>" name="matricula">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputEmail3" value="<?php echo $data_nasc ?>" name="data_nasc">
    </div>
  </div>
  ...
  <fieldset class="">
    ...
    <div class="col-sm-10">
      <div class="form-check">
        ...
        name="escolaridade" 
        id="gridRadios1" 
        value="fundamental" <?php echo $escolaridade == 'fundamental' ? 'checked' : ''?> 
        checked="">
  ...
  <div class="row mb-4 me-9">
    ...
    <div class="col-sm-11">
      <input type="tel" class="form-control" id="inputEmail3" value="<?php echo $telefone ?>" name="telefone">
    </div>
  </div>
  </fieldset>
